...
class TFOverlay extends StatefulWidget {

  final bool _isCorrect;
  final VoidCallback _onTap;

  TFOverlay(this._isCorrect, this._onTap);

  @override
  State createState() => new TFOverlayState();
}

class TFOverlayState extends State<TFOverlay> with SingleTickerProviderStateMixin {
